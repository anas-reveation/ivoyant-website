        ...
        <div className="container py-5">
          <div className="row align-items-center mt-4">
            <div className="col-12 col-md-4 col-lg-6">
              <img src={result.ENV.STRAPI_URL +result?.data?.blogsPages?.data[0]?.attributes?.BgImage?.data?.attributes?.url} className="w-100" />
            </div>
            <div className="col-12 col-md-8 col-lg-6 white-text">
              ...
              <p className="para fw-normal pb-3">{result?.data?.blogsPages?.data[0]?.attributes?.Subheading}</p>

              <div className="row align-items-center">
                <div className="col-3 col-md-2">
                  <img src="./images/blogs/Ellipse 5.svg" className="w-100" />
                </div>
